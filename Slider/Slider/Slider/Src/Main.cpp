...
void Draw()
{
	Engine::StartDrawing(0);
	//スライダー
	Engine::DrawRect(0.0f, 0.0f, 640*slide, 50, 0xff0000,128);
	Engine::DrawRect(0.0f, 50.0f, 50, 450*slide, 0x0000ff,128);
	Engine::DrawRect(50+(640*slide), 450, 640 * (1 - slide), 50, 0xff00ff,128);
	Engine::DrawRect(600, 50+(450*slide), 50, 450 * (1 - slide), 0xff00ff,128);
	//下地
	Engine::DrawRect(0.0f, 0.0f, 640, 50, 0xffffff,64);
	Engine::DrawRect(0.0f, 50.0f, 50, 450, 0xffffff,64);
	Engine::DrawRect(50.0f, 450.0f, 640, 50, 0xffffff,64);
	Engine::DrawRect(600.0f, 50.0f, 50, 450, 0xffffff,64);
